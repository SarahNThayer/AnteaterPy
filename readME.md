# PETER — Anteater API Course & GPA Data Retriever

Peter is a simple Python utility class for retrieving course and grade distribution data from the Anteater API (a REST API providing UC Irvine course data).
